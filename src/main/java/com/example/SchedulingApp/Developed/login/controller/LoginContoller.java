package com.example.SchedulingApp.Developed.login.controller;
...
public class LoginContoller {
    ...
    public String login(
        ...
        // 로그인 유저 조회
        LoginResponseDto responseDto = memberService.login(request.getMemberName(), request.getPassword());
